...
In the **TestCaseClassification.cpp** you can see an example how to do classification with nearest neighbour classifier ($\chi^2$ distance metric) on UIUC dataset.
