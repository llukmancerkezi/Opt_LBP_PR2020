...
Alg::Alg(Mat img, int typeLBP_1, int modeLBP, int n, int r)
{
	...
	case 0:
		if (n > 12)
		{
			cout << "Algorithm will not run for values of neighbours greater than 12." << endl;
			break;
		}
...
{ 
	...
	case 0:
		if (n > 8)
		{
			cout << "Algorithm will not run for values of neighbours greater than 8." << endl;
			break;
		}
	...
	case 1:
		if (n > 16) {
			cout << "Algorithm will not run for values of neighbours greater than 16." << endl;
			break;
		}
